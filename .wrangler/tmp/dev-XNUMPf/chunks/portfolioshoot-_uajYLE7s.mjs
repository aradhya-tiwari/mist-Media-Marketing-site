...
const slag = "/portfolioshoot";
const title = "Portfolio Shoot";
...
export { base_image, portfolioshoot_ as default, desc, images, slag, sub_services, title };
