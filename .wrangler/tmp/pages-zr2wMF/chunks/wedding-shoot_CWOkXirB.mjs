...
const slag = "/weddingshoot";
const title = "Wedding Photography";
const base_image = "../../assets/ambiance/";
const images = [
...
export { base_image, weddingShoot as default, desc, images, slag, sub_services, title };
